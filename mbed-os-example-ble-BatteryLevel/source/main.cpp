...
const static char DEVICE_NAME[] = "BLE_SPEAKER";
...
public:
    ...
    void start() {
        ...
        _event_queue.call_every(500, this, &BatteryDemo::playnote);
...
private:
    ...
    void playnote(void) {
        /*float note = _my_service.get_note();
        if (note > 0) {
